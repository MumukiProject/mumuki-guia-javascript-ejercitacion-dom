En un documento HTML vamos a crear una lista desordenada con distintos países, dos de cada continente, para luego destacar los que pertenezcan al continente que ingresaremos mediante un `prompt`.
